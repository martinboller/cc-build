...
install_nodejs_10() {
    ...
    /usr/bin/logger 'install_nodejs_10()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m-------------------------------------------\e[0m";
    ...
    /usr/bin/logger 'install_nodejs_10() finished' -t 'CyberChef-20250121';
}
...
main() {
    /usr/bin/logger 'Webserver main()' -t 'CyberChef-20250121';
    ...
    disable_sshd_password;
    disable_vagrant_user;
    /usr/bin/logger 'Webserver main() finished' -t 'CyberChef-20250121';

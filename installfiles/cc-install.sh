...
install_prerequisites() {
    ...
    /usr/bin/logger 'apt cleanup' -t 'CyberChef-20250121';
...
install_nodejs_nvm() {
    ...
    /usr/bin/logger 'install_nodejs_nvm()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m-------------------------------------------\e[0m";
    ...
    /usr/bin/logger 'install_nodejs_nvm() finished' -t 'CyberChef-20250121';
}

install_nodejs_debian_repo() {
    /usr/bin/logger 'install_nodejs_debian_repo()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m-------------------------------------------\e[0m";
    ...
    /usr/bin/logger 'install_nodejs_debian_repo() finished' -t 'CyberChef-20250121';
}

obtain_cyberchef_build() {
    /usr/bin/logger 'obtain_cyberchef_build()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m-------------------------------------------\e[0m";
    echo -e "\e[1;32m - obtain_cyberchef_build()\e[0m";
    mkdir -p $BUILD_LOCATION > /dev/null 2>&1;
    cp -r /mnt/build/* $BUILD_LOCATION;
    sync;
    chown -R www-data:www-data $BUILD_LOCATION;
    echo -e "\e[1;32m - obtain_cyberchef_build() finished\e[0m";
    /usr/bin/logger 'obtain_cyberchef_build() finished' -t 'CyberChef-20250121';
}
...
configure_nginx_auth() {
    /usr/bin/logger 'configure_nginx_auth()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m-------------------------------------------\e[0m";
    ...
    /usr/bin/logger 'configure_nginx_auth() finished' -t 'CyberChef-20250121';
}
...
configure_iptables() {
    /usr/bin/logger 'configure_iptables()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m-------------------------------------------\e[0m";
...
__EOF__
    ...
    /usr/bin/logger 'configure_iptables() finished' -t 'CyberChef-20250121';
}
...
create_web_user() {
    /usr/bin/logger 'create_web_user()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m-------------------------------------------\e[0m";
    ...
    /usr/bin/logger 'create_web_user() finished' -t 'CyberChef-20250121';
}

disable_sshd_password() {
    /usr/bin/logger 'disable_sshd_password())' -t 'CyberChef-20250121';
    echo -e "\e[1;32m--------------------------------------------\e[0m";
...
disable_vagrant_user() {
    /usr/bin/logger 'disable_vagrant_user()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m--------------------------------------------\e[0m";
...
create_linux_user() {
    /usr/bin/logger 'create_linux_user()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m--------------------------------------------\e[0m";
...
main() {
    /usr/bin/logger 'CyberChef main()' -t 'CyberChef-20250121';
    echo -e "\e[1;32m - CyberChef main()\e[0m";
    ...
    disable_sshd_password;
    disable_vagrant_user;
    /usr/bin/logger 'CyberChef main() finished' -t 'CyberChef-20250121';
    echo -e "\e[1;32m - CyberChef main() finished\e[0m";
}

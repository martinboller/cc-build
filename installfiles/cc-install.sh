...
obtain_cyberchef_build() {
    /usr/bin/logger 'obtain_cyberchef_build()' -t 'CyberChef-20220107';
    echo -e "\e[1;32m-------------------------------------------\e[0m";
    ...
    /usr/bin/logger 'obtain_cyberchef_build() finished' -t 'CyberChef-20220107';
}
...
main() {
    /usr/bin/logger 'CyberChef main()' -t 'CyberChef-20220107';
    ...
    disable_sshd_password;
    disable_vagrant_user;
    /usr/bin/logger 'CyberChef main() finished' -t 'CyberChef-20220107';
